...
class KisumuMpesaService implements CountyPaymentService {
  ...
  final String _paybillNumber = '174379'; // Using the same for now
  ...
  Future<Map<String, dynamic>> initiatePayment({
    ...
    try {
      ...
      debugPrint('🔵 Sending Kisumu STK Push to: $formattedPhone');
      ...
      final response = await http
          .post(
            ...
            body: jsonEncode({
              ...
              'accountReference': 'Kisumu Water Payment',
              'transactionDesc': 'Water bill payment for Kisumu County',
            }),
          )
      ...
      debugPrint('🔴 Kisumu payment error: $e');
  ...
  String _generateDocumentId(String userName) {
    return 'kisumu_${_cleanUserNameForDocumentId(userName)}_${DateTime.now().millisecondsSinceEpoch}';
  }
  ...
  @override
  String getAccountPrefix() => 'KISUMUWATER';
}
